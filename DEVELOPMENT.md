...
`src/logger/RemoteLogViewer` — отдельный C#/.NET (WPF) проект, не часть C++ сборки движка. Утилита предназначена для перехвата и удобного просмотра сетевых логов игры в реальном времени.
