...
export namespace zzz
{
	  ...
	  *
	  * Этот класс предоставляет функциональность для работы с шириной и высотой,
	  * поддерживая различные числовые типы (например, int, unsigned long, float).
	  * Наследуется от zSerialize для поддержки сериализации и десериализации.
	  *
