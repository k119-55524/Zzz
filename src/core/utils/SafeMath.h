...
{
	/**
	 * @brief Безопасная целочисленная арифметика и валидация диапазонов для разбора бинарных данных.
	 * @details Все значения, прочитанные из файлов или внешних источников, считаются недоверенными.
	 *          Функции ниже проверяют переполнение и выход за границы до любой арифметики,
	 *          приведения типов и выделения памяти.
	 */
