...
* [`docs/resources.md`](../../../../../docs/resources.md) — модель пользовательских ресурсов в `Assets/`, GUID и правила ссылок из конфигов.
* [`docs/scripting.md`](../../../../../docs/scripting.md) — устройство C++-скриптов, `.meta` для скриптов и hot reload.
