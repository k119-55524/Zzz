...
- **Статус:** ✅ Выполнено. Документ сохраняет исторический скоуп этапа; последующие изменения I/O и диспетчеризации из этапов 23–24 имеют приоритет над отдельными формулировками ниже.
...
- **Без аппаратного `GpuUploadScheduler`:** реальный upload через Copy Queue, барьеры и fences вынесены в этап 25.
