# Этап 09: Подсистема ресурсов (`ResourceManager`, `ResourceGarbageCollector`, `DoubleBufferedVector`)
...
- [ ] Зафиксировать Git-коммит: `feat(engine): completed stage 09 - ResourceManager and ResourceGarbageCollector architecture`
