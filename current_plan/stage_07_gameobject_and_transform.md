...
11. **Согласованность с Правилом 13 («Строгая последовательность зависимостей») и Правилом 30 («YAGNI»):**
    - На шаге 7 не вводились зависимости от ещё не реализованных Camera и RenderQueue. По актуальному генплану их минимальный путь входит в этап 22; Frustum/Culling в этапах 33–34.
...
12. **Многопоточная изоляция кадра через неизменяемый снимок (Immutable Render Snapshot, Правило 28):**
    ...
    - Минимальная экстракция опубликованных сценовых данных в кадровые команды реализуется в этапе 22, оптимизация очереди в этапе 35.
