...
- **Статус:** Выполнено по генплану в части CPU-форматов, импорта и чтения MeshData. GPU Mesh/MeshLoader, вершинные/индексные буферы и кэш не входят в выполненную часть: это этап 17 после общего пути upload из этапа 16.
