...
- **Статус:** Выполнено по генплану в части CPU-форматов, импорта и чтения MeshData. GPU-меш и вершинные/индексные буферы не входят в выполненную часть: это этап 19 после CPU-ресурса Mesh этапа 16 и исправлений сцен этапов 17–18.
